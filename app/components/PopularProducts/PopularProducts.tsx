                ...
                >
                  ...
                  <div className=" self-start  w-[85%] m-3 text-sm font-normal text-gray-next-700  hover:text-[#2C742F] ">
                    ...
                    <div className=" flex flex-row items-center justify-between">
                      ...
                      <button
                        className=" flex justify-center items-center  w-10 h-10  leading-9 rounded-full bg-green-next-50 hover:bg-green-next-400 hover:text-white-next  border border-gray-next-100 hover:border-[#2C742F]"
                        onClick={(e) => {
                          e.preventDefault();
