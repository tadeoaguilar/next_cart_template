...
export const NavBarSmall = () => {
    return (
      ...
      <nav className="flex flex-row w-full justify-between py-1 px-[300px] mx-auto items-center shadow-next-box-s bg-white-next  " >
        ...
        <div className="flex flex-row min-w-max items-center">
          <span className=" pr-[6px] whitespace-nowrap font-poppins font-thin text-xs text-gray-next-600">
            Eng
          </span>
          <svg xmlns="http://www.w3.org/2000/svg" width="9" height="6" viewBox="0 0 9 6" fill="none">
            <path d="M8 1.25L4.5 4.75L1 1.25" stroke="#666666" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
          <span className=" pl-5 whitespace-nowrap font-poppins font-thin text-xs text-gray-next-600">
            USD
          </span>
          <svg xmlns="http://www.w3.org/2000/svg" width="9" height="6" viewBox="0 0 9 6" fill="none">
            <path d="M8 1.25L4.5 4.75L1 1.25" stroke="#666666" stroke-linecap="round" stroke-linejoin="round"/>
