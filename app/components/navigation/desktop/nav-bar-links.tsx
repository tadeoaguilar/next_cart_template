      ...
      <nav className=" flex flex-row w-full items-center  px-[--main-x-margin] justify-between bg-gray-next-800 p-4" >
        <div className="flex flex-row w-max items-center justify-center gap-8">
          <div className="flex flex-row items-center">
            <span className="font-poppins text-sm font-medium leading-5 text-white-next ">Home</span>
            <svg className="mx-1" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" fill="none">
              <path d="M1.33332 1.66667L5.99999 6.33334L10.6667 1.66667" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
          <div className="flex flex-row items-center">
            <span className="font-poppins text-sm font-medium leading-5 text-white-next ">Shop</span>
            <svg className="mx-1" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" fill="none">
              <path d="M1.33332 1.66667L5.99999 6.33334L10.6667 1.66667" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
          <div className="flex flex-row items-center">
            <span className="font-poppins text-sm font-medium leading-5 text-white-next ">Pages</span>
            <svg className="mx-1" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" fill="none">
              <path d="M1.33332 1.66667L5.99999 6.33334L10.6667 1.66667" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
          <div className="flex flex-row items-center">
            <span className="font-poppins text-sm font-medium leading-5 text-white-next ">Blog</span>
            <svg className="mx-1" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" fill="none">
              <path d="M1.33332 1.66667L5.99999 6.33334L10.6667 1.66667" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
          
            <span className="font-poppins text-sm font-medium leading-5 text-white-next ">About Us</span>
            <span className="font-poppins text-sm font-medium leading-5 text-white-next ">Contact Us</span>
        ...
        <div className="flex flex-row items-center gap-2">
          ...
          <span className="font-poppins text-sm font-medium leading-5 text-white-next ">(219) 555-0114</span>
        </div>
