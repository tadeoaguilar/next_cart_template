export const BannerTop1: React.FC = () => {
return(

<div className="absolute hero-filter h-full z-10 rounded-[10px] flex flex-col items-center justify-start font-poppins">
...
export const BannerTop2: React.FC = () => {
  return(
    <div className="absolute flex flex-col  w-full h-auto font-poppins ">
