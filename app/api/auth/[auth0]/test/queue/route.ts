...
export async function GET() {
  ...
  const STORAGE_CONNECTION_STRING = process.env.STORAGE_CONNECTION_STRING || "DefaultEndpointsProtocol=https;AccountName=nextcartstorage;AccountKey=r9IR3dkywwx4VXJm7CVwRbcl1PhK0QxYplRnpA6NlWmORMWkCS4SuFRguHmk1QmCuhGA6vDXKdh6+AStofS43g==;EndpointSuffix=core.windows.net";
