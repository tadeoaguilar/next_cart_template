    ...
    switch (containerName) {
      ...
      case "customer":
        item = await container
          .item(resource.id, [resource.storeId, resource.customerId])
          .delete();
        break;
      case "product":
        item = await container
          .item(resource.id, [resource.storeId, resource.categoryId])
          .delete();
        break;
